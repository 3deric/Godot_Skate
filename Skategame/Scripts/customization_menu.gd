...
func _update_ui_from_data() -> void:
	...
	option_button_deck.selected = data.customization_data[CustomizationPart.Part.BOARD]["decal_board"]
	option_button_top_decal.selected = data.customization_data[CustomizationPart.Part.TOP]["decal_top"]
